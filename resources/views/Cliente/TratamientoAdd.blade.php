    ...
    <div class="d-flex justify-content-center aling-content-center">
        ...
        <div class="mt-5  text-center">
            ...
            <div class="form-check form-check-inline">
                {{-- check lunes --}}
                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="dias" value="lunes">
                <label class="form-check-label" for="inlineCheckbox1">Lunes</label>
                {{-- check martes --}}
                <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="dias" value="martes">
                <label class="form-check-label" for="inlineCheckbox2">Martes</label>
                {{-- miercoles --}}
                <input class="form-check-input" type="checkbox" id="inlineCheckbox3" name="dias" value="miercoles">
                <label class="form-check-label" for="inlineCheckbox3">Miercoles</label>
                {{-- jueves --}}
                <input class="form-check-input" type="checkbox" id="inlineCheckbox4" name="dias" value="jueves">
                <label class="form-check-label" for="inlineCheckbox4">Jueves</label>
                {{-- viernes --}}
                <input class="form-check-input" type="checkbox" id="inlineCheckbox5" name="dias" value="viernes">
                <label class="form-check-label" for="inlineCheckbox5">Viernes</label>
                {{-- sabado --}}
                <input class="form-check-input" type="checkbox" id="inlineCheckbox6" name="dias" value="sabado">
                <label class="form-check-label" for="inlineCheckbox6">Sabados</label>
                {{-- domingo --}}
                <input class="form-check-input" type="checkbox" id="inlineCheckbox7" name="dias" value="domingo">
